document.addEventListener('DOMContentLoaded', () => {
    ...
    const masterBeatmaps = {
        // ▼▼▼ ここからが追加部分 ▼▼▼
    "sable_game": [ // ファイル名と同じ名前を付けるのがおすすめ
    ...
    { time: 32.972, lane: 2, type: 2 },
        // ここに、あなたの新しい曲に合わせたノーツをたくさん作っていく
    ],
    ...
    function showSongSelect() {
        currentStage = 0;
        const view = `<p>プレイする曲を選んでください</p><button class="ui-button" data-action="select-song" data-song="sable_game">サブレ原材料</button><button class="ui-button" data-action="select-song" data-song="sakusaku">サクサク冒険</button><button class="ui-button" data-action="select-song" data-song="mochimochi">もちもちリラックス</button>`;
        showView(view);
    }
