document.addEventListener('DOMContentLoaded', () => {
    ...
    const playlists = [
        // --- 既存の曲 ---
        { title: "Tokyo Fuwari – Organic Matcha", file: "matcha.mp3", ready: true, icon: `<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM9 12l2 2 4-4" fill="currentColor" stroke="none"/></svg>` },
        { title: "Dacquoise", file: "dacquoise.mp3", ready: true, icon: `<svg viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>` },
        
        // --- ★ユーザー様が追加した3曲をここに正しく記述しました ---
        { 
            title: "Dorayaki Beat", // カードに表示するタイトル
            file: "dorayaki.mp3",   // ファイル名
            ready: true,            // 再生可能にする
            icon: `<svg viewBox="0 0 24 24"><path d="M9 18V5l12-2v13M9 18a4 4 0 110-8 4 4 0 010 8zm12-2a4 4 0 110-8 4 4 0 010 8z"/></svg>`
        },
        { 
            title: "Fuwari Step",
            file: "fuwari.mp3",
